package com.cpfufufafa.careerpartner.data.repository
...
import com.cpfufufafa.careerpartner.data.network.UserApi
...
class UserRepository {
    ...
    suspend fun updateLearningPath(token: String, id: Int, isDone: Int): retrofit2.Response<UserUpdateResponse>? {
        return UserApi.getApi()?.updateLearningPath(token = token, id = id, isDone = isDone)
    }

package com.fufufafaAI.careerpartner.data.viewmodel
...
import com.fufufafaAI.careerpartner.data.model.UserAchievementsResponse
import com.fufufafaAI.careerpartner.data.model.UserCareerGenerationResponse
import com.fufufafaAI.careerpartner.data.model.UserEducationRequest
import com.fufufafaAI.careerpartner.data.model.UserEducationResponse
import com.fufufafaAI.careerpartner.data.model.UserGenerateLearningPathsResponse
import com.fufufafaAI.careerpartner.data.model.UserInterestsAllRespond
import com.fufufafaAI.careerpartner.data.model.UserInterestsRequest
import com.fufufafaAI.careerpartner.data.model.UserInterestsResponse
import com.fufufafaAI.careerpartner.data.model.UserLearningPathResponse
import com.fufufafaAI.careerpartner.data.model.UserProjectsResponse
import com.fufufafaAI.careerpartner.data.model.UserResponse
import com.fufufafaAI.careerpartner.data.model.UserSkillsAllRespond
import com.fufufafaAI.careerpartner.data.model.UserSkillsRequest
import com.fufufafaAI.careerpartner.data.model.UserSkillsResponse
import com.fufufafaAI.careerpartner.data.model.UserUpdateResponse
import com.fufufafaAI.careerpartner.data.network.BaseResponse
import com.fufufafaAI.careerpartner.data.network.SessionManager
import com.fufufafaAI.careerpartner.data.repository.UserRepository
import com.fufufafaAI.careerpartner.util.Event
...
class UserViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val _userUpdateLearningPathsResult: MutableLiveData<Event<BaseResponse<UserUpdateResponse>>> =
        MutableLiveData()
    val userUpdateLearningPathsResult: LiveData<Event<BaseResponse<UserUpdateResponse>>> =
        _userUpdateLearningPathsResult
    ...
    fun updateLearningPath(activity: Activity, id: Int, isDone: Int) {
        viewModelScope.launch {
            val response =
                userRepo.updateLearningPath(
                    token = "Bearer ${SessionManager.getToken(activity)}",
                    id = id,
                    isDone = isDone
                )
            try {
                if (response?.code() == 200) {
                    _userUpdateLearningPathsResult.value = Event(BaseResponse.Success(response.body()))
                } else {
                    _userUpdateLearningPathsResult.value =
                        Event(BaseResponse.Error("Check your internet connection"))
                }
            } catch (e: ConnectException) {
                _userUpdateLearningPathsResult.value =
                ...
                _userUpdateLearningPathsResult.value = Event(BaseResponse.Error("Exception occurred"))
            }
        }
    }

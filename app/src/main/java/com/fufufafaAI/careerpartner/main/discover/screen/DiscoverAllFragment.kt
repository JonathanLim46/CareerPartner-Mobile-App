package com.fufufafaAI.careerpartner.main.discover.screen
...
import com.fufufafaAI.careerpartner.data.viewmodel.InternshipViewModel
import com.fufufafaAI.careerpartner.data.viewmodel.VolunteerViewModel
import com.fufufafaAI.careerpartner.databinding.FragmentDiscoverAllBinding
import com.fufufafaAI.careerpartner.main.discover.adapter.DiscoverDataAdapter
import com.fufufafaAI.careerpartner.main.discover.data.DiscoverData
        ...
        viewModelInternship.getInternshipsDataResult.observe(viewLifecycleOwner) {
            when (it) {
                is BaseResponse.Loading -> {
                    binding.rvDiscoverAll.visibility = View.GONE
                ...
                is BaseResponse.Success -> {
                    ...
                    updateRv()
                    binding.rvDiscoverAll.visibility = View.VISIBLE
